...
tweet <- paste(n_articles, 'new #datascience research articles were published on @arXiv yesterday.', n_ml, 'discussed #machinelearning. Come read the #datasciencearxiv', POST_URL)
