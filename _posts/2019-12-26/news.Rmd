...
description: |
  45 new data science research articles were published on @arXiv yesterday. 23 discussed machine learning.
...
tweet <- paste(n_articles, 'new #datascience research articles were published on @arXiv yesterday.', n_ml, 'discussed #machinelearning.')
